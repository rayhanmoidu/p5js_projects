...
class Tree {
    constructor(mode, angleOffset, xPos, yPos, fractalFactor, branchingFactor, treeHeight, branchLength, branchLengthScalingFactor, startingMass, massScalingFactor) {
        ...
        if (mode=="starting") {
            ...
            this.setupTree_basicFractal(xPos, yPos, angleOffset, fractalFactor, branchingFactor, treeHeight, branchLength, branchLengthScalingFactor, startingMass, massScalingFactor);
        }
    ...
    setupTree_basicFractal(xPos, yPos, angleOffset, fractalFactor, branchingFactor, treeHeight, branchLength, branchLengthScalingFactor, startingMass, massScalingFactor) {
        let springs = [];
        let particles = [];

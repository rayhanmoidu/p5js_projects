class Om {
  ...
  draw() {
    ...
    this.renderOmComponent(this.omComponents.getPosition(0, sin(this.engine.getTime()/100)+1), this.imgs[0], p.om1x, p.om1y)
    this.renderOmComponent(this.omComponents.getPosition(1, sin(this.engine.getTime()/100)+1), this.imgs[1], p.om2x, p.om2y)
    this.renderOmComponent(this.omComponents.getPosition(2, sin(this.engine.getTime()/100)+1), this.imgs[2], p.om3x, p.om3y)
    this.renderOmComponent(this.omComponents.getPosition(3, sin(this.engine.getTime()/100)+1), this.imgs[3], p.om4x, p.om4y)
    this.renderOmComponent(this.omComponents.getPosition(4, sin(this.engine.getTime()/100)+1), this.imgs[4], p.om5x, p.om5y)
    // }
  }
